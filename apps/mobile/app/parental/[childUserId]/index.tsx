...
import { ScreenContainer, ScreenHeader, Card, Text, Toggle, ListItem, Button, Badge, InputModal } from "@/components/ui";
...
export default function ChildDetailScreen() {
  ...
  async function handleCreateTask(title: string) {
    try {
      await createTask.mutateAsync({ title, rewardMinutes: STEP });
      setTaskOpen(false);
    } catch {
      /* keep modal open */
    }
  ...
  return (
    <ScreenContainer>
      ...
      <InputModal
        visible={taskOpen}
        title={t("parental.taskCreate.title")}
        subtitle={t("parental.taskCreate.subtitle")}
        placeholder={t("parental.taskCreate.placeholder")}
        confirmLabel={t("parental.tasksAdd")}
